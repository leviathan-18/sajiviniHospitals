import cardiogramIcon from '../../images/assets/cardiogram-icon-medical-icon-in-the-hospital-icon-sPdUiBDP.jpg';
import foundersPhoto from '../../images/assets/founders_photo.jpg';
  ...
  return (
    <section className="pt-0 pb-16 md:pb-20 bg-[linear-gradient(180deg,rgba(253,250,248,0.96),#ffffff)] font-sans">
      <div className="bg-[#AD3048] text-white py-10 md:py-12 mb-10 md:mb-12 shadow-[0_12px_30px_rgba(173,48,72,0.18)]">
        <div className="container mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 sm:px-6">
          <div>
            <p className="mb-2 text-[10px] uppercase tracking-[0.2em] text-white/75 sm:mb-3 sm:text-xs md:text-sm md:tracking-[0.35em]">About Sanjivini</p>
            <h1 className="text-xl font-serif uppercase tracking-[0.08em] sm:text-2xl md:text-5xl md:tracking-[0.18em]">
            Our Founders
            </h1>
          </div>
          <img
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6">
        <div className="grid gap-8 lg:gap-10 items-start lg:grid-cols-2">
          <div className="rounded-[30px] border border-[#ead7db] bg-white shadow-[0_22px_50px_rgba(21,62,76,0.12)] overflow-hidden">
            ...
            <div className="grid grid-cols-1 gap-3 border-t border-[#ead7db] bg-[#f9f1f2] px-4 py-5 sm:grid-cols-2 sm:gap-4 md:px-6">
          ...
          <div className="rounded-[30px] border border-[#ead7db] bg-[#fffdfd] p-5 sm:p-7 md:p-10 shadow-[0_18px_40px_rgba(21,62,76,0.07)]">
            ...
            <h2 className="mt-6 text-2xl font-bold tracking-tight text-[#1b2230] sm:text-3xl md:text-4xl">
            ...
            <p className="mt-6 text-center font-serif text-2xl text-[#194656] sm:text-3xl md:text-4xl">
